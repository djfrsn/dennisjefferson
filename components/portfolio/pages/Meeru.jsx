      ...
      <ContentItem alignment="center">
        <ContentItemInner>
          ...
          <ContentItemParagraph alignment="center">
            Meeru is the app that allows you to play multiple videos from
            streaming websites at the same time.
          </ContentItemParagraph>
          ...
          <ContentItemList>
            ...
            <li>
              Save the video lists to a .meeru file. Simply double click the
              .meeru file to re-open all the saved videos.
            </li>
          </ContentItemList>
